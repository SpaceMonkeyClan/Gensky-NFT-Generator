...
#ifndef PURCHASEKIT_SWIFT_H
#define PURCHASEKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PurchaseKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// PurchaseKit manager class to setup and configure the in-app purchases
SWIFT_CLASS("_TtC11PurchaseKit9PKManager")
...
@interface PKManager (SWIFT_EXTENSION(PurchaseKit)) <SKPaymentTransactionObserver, SKProductsRequestDelegate>
